...
const FormSchema = z.object({
  name: z.string().min(2, { message: "Agency name is required" }),
  companyEmail: z.string().email({ message: "Email is required" }),
...
const AgencyDetails = ({ data }: props) => {
  ...
  const handleDeleteAgency = async () => {
    ...
    try {
      const response = await handleAgencyDelete(data?.id);
      toast.message("Agency deleted successfully", {
          ...
          <Form {...form}>
            ...
            >
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex-1">
                    ...
                    <FormControl>
                      <Textarea placeholder="123 st..." {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              {data?.id && (
                <div className="flex flex-col gap-2">
                  ...
                  <FormDescription>
                    ...
                    goals grow too so dont forget to set the bar high!
                  </FormDescription>
                  <NumberInput
              ...
              <Button type="submit" disabled={isLoading}>
                {isLoading ? <Loading /> : <h1>Save Agency Information</h1>}
              </Button>
            </form>
          </Form>
          {data?.id && (
            <div className=" flex flex-col items-start justify-between rounded-lg border border-destructive gap-4 p-4 mt-4">
              <div>
                <div className="text-rose-500 font-bold">Danger Zone</div>
              </div>
              <div className="text-muted-foreground">
                Deleting your agency cannot be undone. This will also delete all
                sub accounts and all the data related to your sub accounts. Sub
